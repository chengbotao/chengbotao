import{_ as n,o as s,c as a,e}from"./app.2c890e59.js";const t={},p=e(`<h2 id="递归函数" tabindex="-1"><a class="header-anchor" href="#递归函数" aria-hidden="true">#</a> 递归函数</h2><blockquote><p>程序调用自身<br> 在函数定义有直接或间接调用自身</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 递归</span>
