import{_ as t,r as o,o as i,c as l,b as n,f as e,d as a,e as p}from"./app.2c890e59.js";const r={},c=p(`<h3 id="eslint-安装配置" tabindex="-1"><a class="header-anchor" href="#eslint-安装配置" aria-hidden="true">#</a> eslint 安装配置</h3><blockquote><p>代码质量: 约定语法的使用, 如: 必须使用全等; 不能使用<code>var</code>定义变量等<br> 代码格式: 影响代码的格式美观, 如: 代码结束必须添加分号; 缩进的控制等</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装eslint</span>
