import{_ as n,p as s,q as a,a1 as e}from"./framework-204010b2.js";const p={},t=e(`<h2 id="程序流程图" tabindex="-1"><a class="header-anchor" href="#程序流程图" aria-hidden="true">#</a> 程序流程图</h2><blockquote><p>以简单的图形符号来表示问题求解的步骤<br> 流程图是问题求解的最基本、最重要的分析技术</p></blockquote><p><strong>常用流程图图形符号</strong></p><div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre class="language-mermaid"><code><span class="token keyword">graph</span> TD<span class="token punctuation">;</span>
