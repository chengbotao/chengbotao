import{_ as t,M as o,p,q as i,R as n,t as a,N as e,a1 as l}from"./framework-204010b2.js";const c={},u=l(`<h3 id="创建项目文件夹" tabindex="-1"><a class="header-anchor" href="#创建项目文件夹" aria-hidden="true">#</a> 创建项目文件夹</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建项目文件夹</span>
